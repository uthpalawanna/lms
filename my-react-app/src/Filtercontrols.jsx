...
export function CourseSelect({ value, onChange, showAllOption = true }) {
...
export function DateField({ value, onChange, placeholder = "Y-M-d" }) {
...
export function CloudSearchEmptyIcon() {
  return (
